...
class SettingsObject_System_Headless
{
  public:
	...
	SettingsObject_System_Headless(int argc, char **argv)
	{
		Parse(argc, argv);
	}
...
class SettingsObject_System
{
  public:
	...
	SettingsObject_System(int argc, char **argv)
	{
		Parse(argc, argv);
	}
...
class SettingsObject_Files
{
  public:
	...
	SettingsObject_Files(int argc, char **argv)
	{
		Parse(argc, argv);
	}
...
class SettingsObject_Compiler
{
  public:
	...
	SettingsObject_Compiler(int argc, char **argv)
	{
		Parse(argc, argv);
	}
...
class SettingsObject_Document
{
  public:
	...
	SettingsObject_Document(int argc, char **argv)
	{
		Parse(argc, argv);
	}
